...
2. When applying CODE_REVIEW.md / REVIEW.md feedback, you still must not edit any file outside PLAN.md's scope. If a review point cannot be resolved without out-of-scope edits, ignore it and record the reason in the "남은 TODO" section of IMPL.md.
